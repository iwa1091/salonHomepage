                ...
                <div class="card-content">
                    <form id="reservationForm" class="contact-form">
                        ...
                        <div class="form-field">
                            ...
                            <select id="service" name="service_id" required class="select-field">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-field">
                                ...
                                <select id="time" name="start_time" class="select-field" required>
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="message" name="notes" placeholder="アレルギーの有無、ご質問、ご要望などございましたらお書きください" rows="4" class="textarea-field"></textarea>
                        </div>
                        ...
                        <p id="reservationMessage" class="text-center mt-3"></p>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-content contact-info">
                    <div class="contact-item">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8c0 4.5-6 9-6 9s-6-4.5-6-9a6 6 0 0 1 12 0z"/><circle cx="12" cy="8" r="2"/></svg>
                        </span>
                        <div>
                            <p class="info-label">住所</p>
                            <p class="info-text">〒290-0055<br>千葉県市原市五井東1丁目15-3<br> ブルメリア102</p>
                        </div>
                    </div>

                    <div class="contact-item">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2.08L16 21.95A19.95 19.95 0 0 1 2.05 6L2.08 4.18A2 2 0 0 1 4.18 2h3a2 2 0 0 1 2 2.18A15.96 15.96 0 0 0 14.5 14.5A15.96 15.96 0 0 0 19.82 19.82a2 2 0 0 1 2.18 2.18z"/></svg>
                        </span>
                        <div>
                    ...
                    <div class="contact-item">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 6L12 13L2 6"/></svg>
                        </span>
                        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title with-icon">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                        </span>
                        営業時間
                    </h3>
                </div>
                <div class="card-content">
                    <div class="hours-list">
                        <div class="hours-item"><span class="day">日曜日と月曜日<br>(祝日等不定休有り)</span><span class="time">定休日</span></div>
                        <div class="hours-item"><span class="day">火曜日〜土曜日</span><span class="time">09:00〜17:00</span></div>

                    </div>
                    <div class="notice-box">
                        <p>※お詫び<br>
                        小さな子どもがおります関係で、やむを得ずご予約日時の変更をお願いする場合がございます。<br>
                        その際はできる限り柔軟に対応させていただきますので、何卒ご理解くださいますようお願いいたします。</p>
                    </div>
                </div>
            </div>
